 ...
 * @notice Contrato para cada par de liquidez
 * @dev Basado en el diseño de Uniswap V2 con mejoras de seguridad
 */
...
contract MexiPair is ERC20Permit {
    ...
    // ============ CONSTRUCTOR ============
    constructor() ERC20Permit("MexiSwap LP Token") {
        factory = msg.sender;
    }
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external {
        ...
        uint balance1;
        {
            ...
            if (data.length > 0) IMexiCallee(to).mexiCall(msg.sender, amount0Out, amount1Out, data);
            balance0 = IERC20(_token0).balanceOf(address(this));
            balance1 = IERC20(_token1).balanceOf(address(this));
        }
...
interface IMexiCallee {
    function mexiCall(address sender, uint amount0, uint amount1, bytes calldata data) external;
}
